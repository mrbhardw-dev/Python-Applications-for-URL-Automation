# SCRIPT TO VERIFY INTERNAL URLS HTTPS STATUS CODE
...
urls_file = f'{my_location}\\FILES\\ema-prod-app.csv'
urls_status = f'{my_location}\\FILES\\int-verified-list.csv'
log_file_path = f'{my_location}\\FILES\\AppIntLogs.log'
